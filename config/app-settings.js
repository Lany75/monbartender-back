...
const appSettings = {
    winston: {
        ...
        transports: [
          ...
          //
          new winston.transports.DailyRotateFile({ dirname: path.join(appRoot.path, '/logs'), filename: 'error-%DATE%.log', datePattern: 'YYYY-MM-DD', zippedArchive: true, maxSize: '20m', maxFiles: '14d', level: 'error' }),
          new winston.transports.DailyRotateFile({ dirname: path.join(appRoot.path, '/logs'), filename: 'combined-%DATE%.log', datePattern: 'YYYY-MM-DD', zippedArchive: true, maxSize: '20m', maxFiles: '14d' })
        ],
    ...
    swagger: {
        ...
        definition: {
          ...
          "servers": [
            ...
            {
              "url": "https://{app}.herokuapp.com:{port}/",
              "description": "The production API server",
              "variables": {
                "app": {
                  "enum": [
                    "monbartender-back-staging",
                    "monbartender-back-prod"
                  ],
